...
public class FakeDB {
	...
	//This is a static block, and it is code that executes the very first time a class is loaded.
	//Anytime the class is called or reference, it will run the code in here.
	static {
